...
| File | Status | Notes |
|------|--------|-------|
| `chains_R1-7B.json` | **CLUSTER-ONLY, PARTIAL (~38%) — ARM DROPPED** | 7B chain generation stopped mid-run (~380/1000 chains, June 6–8). **Decision 2026-06-12 (Tony): the 7B arm is dropped for the paper** (off the critical path under scooping pressure); the partial corpus is retained for possible thesis-stage generalisation work. Do not treat as a corpus. |
